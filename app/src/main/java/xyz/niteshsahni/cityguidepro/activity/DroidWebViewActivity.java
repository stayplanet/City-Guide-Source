...
public class DroidWebViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(xyz.niteshsahni.cityguidepro.R.layout.webview);
		con = this;
		progressBar = (ProgressBar) findViewById(xyz.niteshsahni.cityguidepro.R.id.progressBar12);
	...
	private void updateWebView(String url) {
		...
		fweBview = (WebView) findViewById(xyz.niteshsahni.cityguidepro.R.id.fbwebView);
