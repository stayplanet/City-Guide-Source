...
//	String url = "https://maps.google.com/?q="+ AllConstants.lat+","+ AllConstants.lng+"";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(xyz.niteshsahni.cityguidepro.R.layout.mapview);
		con = this;
		mapprogress = (ProgressBar) findViewById(xyz.niteshsahni.cityguidepro.R.id.MprogressBar);
	...
	private void updateWebView(String url) {
		...
		fweBview = (WebView) findViewById(xyz.niteshsahni.cityguidepro.R.id.mapView);
